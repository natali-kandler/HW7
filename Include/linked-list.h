...
/* Both will be defined elsewhere */
struct list;
struct node;
 ...
 * the user must validate it
 */
int list_remove(struct list *list, struct node *it);
 ...
 */
struct node* list_next(struct node* it);
 ...
 */
struct node* list_prev(struct node* it);
